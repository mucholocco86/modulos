...
default persistent.wells_choice_size = 24
default persistent.wells_choice_spacing = 15
default persistent.wells_choice_xpos = 0.5
default persistent.wells_choice_ypos = 0.5
default persistent.wells_choice_width = 420
...
init python:
    ...
    def restore_wells_defaults():
        ...
        persistent.wells_choice_width = 420 # Valor padrão ideal que você usa
