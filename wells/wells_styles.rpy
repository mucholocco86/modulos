...
# ===============================================================================
# ESTILOS ADAPTATIVOS DA TELA DE ESCOLHAS (WELLS FRAMEWORK)
# ===============================================================================

style wells_choice_button is default:
    # Fatiamento cirúrgico de bordas: protege as setas nas extremidades esquerda e direita
...
style wells_choice_text is default:
    font "wells/fonts/cabin-regular.ttf" 
    color "#e7e2e2"        # O amarelo dourado exato extraído do jogo
    hover_color "#e7e2e2"  # O branco puro selecionado extraído do jogo
    size 28
