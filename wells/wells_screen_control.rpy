...
screen dialogue_adjusts():
    ...
    frame:
        ...
        vbox:
            ...
            # 📦 O NOVO QUADRO ROLÁVEL CENTRAL
            frame:
                xpos 120 ypos 60    # Mantém o recuo perfeito na tela para os botões aparecerem ao lado
                xsize 760 ysize 400  # Limita o tamanho físico máximo do seu quadrado central
                background None      
                padding (10, 10, 10, 10)

                # [IGUAL AO SEU PRINT] Ancoragem rígida: centro (c) e barra na direita (r)
                side "c r":
                    xalign 0.5 ypos 0 spacing 15
                    
                    # O viewport que vai segurar as suas colunas de barras
                    viewport:
                        id "wells_painel_controles_vp" # ID único para não dar conflito
                        mousewheel True draggable True arrowkeys True
                        # Se você quiser que o tamanho físico interno seja fixado:
                        xsize 720 ysize 380 

                        # Linha horizontal interna que segura as suas colunas de barras originais
                        hbox:
                            spacing 40
                            xsize 720 # [CORREÇÃO] Força o conteúdo a respeitar a largura da caixa
                            # ==================================================
                            # COLUNA DA ESQUERDA (TEXTO E ESPAÇAMENTOS)
                            # ==================================================
                            vbox:
                                spacing 14     
                                yalign 0.0
                                ...
                                vbox spacing 4:
                                    ...
                                    bar:
                                        ...
                                        thumb "wells/gui/pino.png" thumb_shadow None thumb_offset 1

                                # TAMANHO DAS CHOICES
                                vbox spacing 4:
                                    label _("Tam. Choices: [persistent.wells_choice_size]"):
                                        text_size 26
                                        text_color "#2cf1ff"
                                        padding (15, 2)
                                        background Frame("wells/gui/label_frame.png", 10, 10)
                                    bar:
                                        value FieldValue(persistent, 'wells_choice_size', range=80, step=1) 
                                        xsize 320 ysize 25 xalign 0.5
                                        idle_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        hover_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        idle_left_bar Frame("wells/gui/barra_cheia.png", 5, 5)
                                ...
                                # CHOICE VERTICAL (Y)
                                vbox spacing 4:
                                    label _("Choice_Vert. (Y)"):
                                        text_size 26
                                        text_color "#2cf1ff"
                                        padding (15, 2)
                                        background Frame("wells/gui/label_frame.png", 10, 10)
                                    bar:
                                        value FieldValue(persistent, 'wells_choice_ypos', range=1.0, step=0.05) 
                                        xsize 320 ysize 25 xalign 0.5
                                        idle_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        hover_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        idle_left_bar Frame("wells/gui/barra_cheia.png", 5, 5)
                                ...
                                vbox spacing 4:
                                    ...
                                    bar:
                                        ...
                                        thumb "wells/gui/pino.png" thumb_shadow None thumb_offset 1
                            # ==================================================
                            # COLUNA DA DIREITA (DIÁLOGOS E AJUSTES DE ESCHOICE)
                            # ==================================================
                            vbox:
                                spacing 14   
                                yalign 0.0
                                ...
                                # TAMANHO DIÁLOGO MÚLTIPLO
                                vbox spacing 4:
                                    label _("Tam. Diál, Multiple: [persistent.wells_multiple_text_size]"):
                                        text_size 26
                                        text_color "#2cf1ff"
                                        padding (15, 2)
                                        background Frame("wells/gui/label_frame.png", 10, 10)
                                ...
                                # CHOICE HORIZONTAL (X)
                                vbox spacing 4:
                                    label _("Choice_Horiz. (X)"):
                                        text_size 26
                                        text_color "#2cf1ff"
                                        padding (15, 2)
                                        background Frame("wells/gui/label_frame.png", 10, 10)
                                    bar:
                                        value FieldValue(persistent, 'wells_choice_xpos', range=1.0, step=0.05) 
                                        xsize 320 ysize 25 xalign 0.5
                                        idle_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        hover_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        idle_left_bar Frame("wells/gui/barra_cheia.png", 5, 5)
                                ...
                                # CHOICE SPACING
                                vbox spacing 4:
                                    label _("Choice_spacing: [persistent.wells_choice_spacing]"):
                                        text_size 26
                                        text_color "#2cf1ff"
                                        padding (15, 2)
                                        background Frame("wells/gui/label_frame.png", 10, 10)
                                ...
                                # LARGURA HORIZONTAL DAS ESCOLHAS
                                vbox spacing 4:
                                    label _("Choices. Largura: [persistent.wells_choice_width]"):
                                        text_size 26
                                        text_color "#2cf1ff"
                                        padding (15, 2)
                                        background Frame("wells/gui/label_frame.png", 10, 10)
                                    bar:
                                        value FieldValue(persistent, 'wells_choice_width', range=1000, step=10) 
                                        xsize 320 ysize 25 xalign 0.5
                                        idle_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        hover_right_bar Frame("wells/gui/barra_vazia.png", 5, 5)
                                        idle_left_bar Frame("wells/gui/barra_cheia.png", 5, 5)
                                ...
                                vbox spacing 4:
                                    ...
                                    bar:
                                        ...
                                        hover_left_bar Frame("wells/gui/barra_cheia.png", 5, 5)
                                        thumb "wells/gui/pino.png" thumb_shadow None thumb_offset 1
                            # Linhas que fecham as colunas do viewport de forma segura
                            pass


                    # [IGUAL AO SEU PRINT] A barrinha de rolagem vertical grudada na direita
                    vbar:
            ...
            # --------------------------------------------------------------
            # [ESPAÇO RESERVADO]: Aqui começam os seus botões verticais 
            # originais do lado direito (Pular Texto, Resets Gerais, etc.)
            # --------------------------------------------------------------
            frame:
                xpos 920 ypos -400    # Mantém o recuo perfeito na tela para os botões aparecerem ao lado
                xsize 186 ysize 48  # Limita o tamanho físico máximo do seu quadrado central
                background None      
                padding (10, 10, 10, 10)
                ...
                vbox:
                    ...
                    # Botão Liga/Desliga para o Contorno de Texto do Slot 3
                    button:
                        padding (0, 0, 0, 0)
                        xysize (180, 42)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                        ...
                        xalign 0.5
                        text "CONTORNO" xalign 0.5 yalign 0.5 size 18 color ("#2bff00" if getattr(persistent, "wells_force_outline", False) else "#ffffff") hover_color "#2bff00"
                    # Botão Alternador Dinâmico para os Slots de Escolha (Choices)
                    button:
                        padding (0, 0, 0, 0)
                        xysize (180, 42)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                    ...
                    button:
                        ...
                        xalign 0.5
                        text _("Reset choice") xalign 0.5 yalign 0.5 size 20 hover_color "#2bff00"
                    button:
                        padding (0, 0, 0, 0)
                        xysize (180, 42)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
        ...
        vbox:
            ...
            vbox:
                ...
                hbox:
                    ...
                    # Botão Padrão do Framework (Pass-Through)
                    button:
                        padding (0, 0, 0, 0)
                        xysize (130, 45)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                        ...
                        text "PADRÃO" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_say_slot == 0 else "#ffffff") hover_color "#2bff00"

                    # Botão Novo: Wells Clássico (Aciona o layout legado movido para o Slot 6)
                    button:
                        padding (0, 0, 0, 0)
                        xysize (130, 45)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                        hover_background Frame("wells/gui/Button-hover.png", 5, 5)
                        action SetField(persistent, "wells_say_slot", 6)
                        text "Wells Screen" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_say_slot == 6 else "#ffffff") hover_color "#2bff00"
                ...
                hbox:
                    ...
                    button:
                        ...
                        text "Framework" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_say_slot == 3 else "#ffffff") hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text "ETERNUM" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_say_slot == 2 else "#ffffff") hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text "BEING A DIK" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_say_slot == 1 else "#ffffff") hover_color "#2bff00"
                ...
                hbox:
                    ...
                    button:
                        ...
                        text "PADRÃO +" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_multiple_slot == 0 else "#ffffff") hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text "ETERNUM +" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_multiple_slot == 2 else "#ffffff") hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text "Incubus" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_multiple_slot == 6 else "#ffffff") hover_color "#2bff00"
                hbox:
                    xalign 0.5
                    spacing 10
                    ...
                    button:
                        ...
                        text "Esquerda" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_multiple_slot == 4 else "#ffffff") hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text "ETERNUM -" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_multiple_slot == 3 else "#ffffff") hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text "Direita" xalign 0.5 yalign 0.5 size 16 color ("#2bff00" if persistent.wells_multiple_slot == 5 else "#ffffff") hover_color "#2bff00"
